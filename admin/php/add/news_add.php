...
<body>
            ...
            <table class="layui-table">
                <tbody>
                    <tr>
                        ...
                        <td colspan="1">
                            <div class="layui-input-inline">
                                <input type="text" style="width:200px" name="news_class" required="" lay-verify="required"
                                    autocomplete="off" class="layui-input">
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <script id="editor" type="text/plain" style="width:1024px;height:250px;">
                            </script>
                        </td>
                    </tr>
                </tbody>
    ...
    function getContent() {
        ...
        $.ajax({
            ...
            type: "post",
            data: {
                "news_all": UE.getEditor('editor').getContent(),
                "news_title": x.value
            },
            dataType: "text",
