...
$sql_news = "INSERT INTO cptp_news (news_title, news_summary, news_all, news_source, news_click, news_website,news_img_url,news_wap_img_url,news_class) VALUES('{$news_title}', '{$news_summary}', '{$news_all}', '{$news_source}', '{$news_click}', '{$website}','{$img_pc_url}','{$img_wap_url}','{$news_class}')";
