...
//获取关键词的页面和网站属性
$sql_getclass="SELECT news_class FROM cptp_news";
...
$sql = "SELECT * FROM cptp_news WHERE news_id='{$news_id}'";
            ...
            <table class="layui-table">
                <tbody>
                    ...
                    <td colspan="1"><input type="text" style="width:100px" name="news_click" required="" lay-verify="required"
                            ...
                            <td colspan="1">新闻分类</td>
                    <td colspan="1"><input type="text" style="width:200px" name="news_class" required="" lay-verify="required"
                            autocomplete="off" class="layui-input" value="<?php echo $news_class;?>"></td>
